...
private[glutenproject] class GlutenDriverPlugin extends DriverPlugin {
  private var glutenDriverEndpoint: GlutenDriverEndpoint = null
  ...
  override def init(sc: SparkContext, pluginContext: PluginContext): util.Map[String, String] = {
    ...
    glutenDriverEndpoint = new GlutenDriverEndpoint()
    GlutenListenerFactory.addToSparkListenerBus(sc, glutenDriverEndpoint.driverEndpoint)
